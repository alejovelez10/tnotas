...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { description: @slider.description, image: @slider.image, name: @slider.name, state: @slider.state } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { description: @slider.description, image: @slider.image, name: @slider.name, state: @slider.state } }
