...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post catalogs_url, params: { catalog: { description: @catalog.description, image: @catalog.image, name: @catalog.name, state: @catalog.state } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { description: @catalog.description, image: @catalog.image, name: @catalog.name, state: @catalog.state } }
