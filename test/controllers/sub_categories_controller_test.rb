...
class SubCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post sub_categories_url, params: { sub_category: { category_id: @sub_category.category_id, description: @sub_category.description, icon: @sub_category.icon, image: @sub_category.image, name: @sub_category.name, state: @sub_category.state, user_id: @sub_category.user_id } }
    end
  ...
  test "should update sub_category" do
    patch sub_category_url(@sub_category), params: { sub_category: { category_id: @sub_category.category_id, description: @sub_category.description, icon: @sub_category.icon, image: @sub_category.image, name: @sub_category.name, state: @sub_category.state, user_id: @sub_category.user_id } }
